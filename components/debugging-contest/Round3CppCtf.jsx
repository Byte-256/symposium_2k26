...
import { BUGGY_C_CODE, ROUND3_FLAG } from './constants';
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6 }}>
      <div className="mb-6">
        <h2 className="bg-gradient-to-r from-pink-400 to-rose-400 bg-clip-text text-3xl font-bold text-transparent">
          Round 3: TinyCC C CTF
        </h2>
        <p className="mb-4 mt-4 text-lg text-slate-300">
          Debug the C code using TinyCC to find the hidden flag. Submit the flag to win!
        </p>
      ...
      <div className="space-y-6">
        <TccCompileRunPanel
          initialCode={BUGGY_C_CODE}
          runButtonLabel="Compile & Run (TinyCC)"
        />
